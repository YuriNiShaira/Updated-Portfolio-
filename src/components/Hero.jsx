    ...
    <section id="home" className="min-h-screen flex items-center justify-center px-6 py-20 relative overflow-hidden z-10">
      ...
      <div className="max-w-7xl mx-auto text-center relative z-10">
        ...
        <h1 className="text-5xl md:text-7xl font-bold mb-4">
          <span className="text-[#facc15] inline-block hover:scale-105 transition-transform duration-300">Yuri</span>
          <span className="text-gray-200 inline-block hover:scale-105 transition-transform duration-300"> Mauricio</span>
        </h1>
