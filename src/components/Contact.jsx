          ...
          <div className="space-y-8 flex flex-col justify-center">
            ...
            <div 
              ...
              onClick={() => {
                ...
                window.location.href = 'mailto:yurimauricio0404@gmail.com';
              }}
            >
              ...
              <div>
                ...
                <span className="text-gray-300 font-light group-hover:text-[#00E5FF] transition-colors">yurimauricio0404@gmail.com</span>
              </div>
            </div>
            ...
            <div 
              ...
              onClick={() => {
                ...
                window.open('https://github.com/YuriNiShaira', '_blank', 'noopener,noreferrer');
              }}
            >
              <div className="w-12 h-12 bg-[#00E5FF]/5 border border-[#00E5FF]/20 rounded-sm flex items-center justify-center group-hover:bg-[#00E5FF] group-hover:shadow-[0_0_15px_rgba(0,229,255,0.4)] transition-all duration-300">
              ...
              <div>
                ...
                <span className="text-gray-300 font-light group-hover:text-[#00E5FF] transition-colors">@YuriNiShaira</span>
              </div>
            </div>
            ...
            <div 
              ...
              onClick={() => {
                ...
                window.open('https://www.linkedin.com/in/yuri-mauricio-993b3b396/', '_blank', 'noopener,noreferrer');
              }}
            >
              <div className="w-12 h-12 bg-[#00E5FF]/5 border border-[#00E5FF]/20 rounded-sm flex items-center justify-center group-hover:bg-[#00E5FF] group-hover:shadow-[0_0_15px_rgba(0,229,255,0.4)] transition-all duration-300">
              ...
              <div>
                ...
                <span className="text-gray-300 font-light group-hover:text-[#00E5FF] transition-colors">Yuri Mauricio</span>
              </div>
            </div>
            ...
            <div 
              className="flex items-center space-x-5 group cursor-pointer"
              onClick={() => {
                analytics.trackSocialClick('Facebook');
                window.open('https://www.facebook.com/yuri.mauricio.52', '_blank', 'noopener,noreferrer');
              }}
            >
              <div className="w-12 h-12 bg-[#00E5FF]/5 border border-[#00E5FF]/20 rounded-sm flex items-center justify-center group-hover:bg-[#00E5FF] group-hover:shadow-[0_0_15px_rgba(0,229,255,0.4)] transition-all duration-300">
            ...
            <div 
              ...
              onClick={() => {
                ...
                window.open('https://www.instagram.com/yuriii.py/', '_blank', 'noopener,noreferrer');
              }}
            >
              <div className="w-12 h-12 bg-[#00E5FF]/5 border border-[#00E5FF]/20 rounded-sm flex items-center justify-center group-hover:bg-[#00E5FF] group-hover:shadow-[0_0_15px_rgba(0,229,255,0.4)] transition-all duration-300">
