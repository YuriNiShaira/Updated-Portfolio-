    ...
    <nav className={`fixed w-full z-50 transition-all duration-500 py-4 px-6 lg:px-8 ${scrolled ? 'bg-[#0A192F]/90 backdrop-blur-md shadow-lg' : 'bg-transparent'}`}>
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center space-x-1">
          ...
          <a href="/Yurisho F Mauricio  Resume Updated" download className="ml-2 px-5 py-2.5 bg-[#facc15] text-[#0A192F] text-sm font-medium rounded-xl hover:shadow-[0_0_20px_rgba(250,204,21,0.5)] transition-all duration-300 flex items-center gap-2">
      ...
      {isOpen && (
        <div className="md:hidden absolute left-4 right-4 top-20 bg-[#112240]/95 backdrop-blur-xl border border-gray-800 rounded-2xl shadow-2xl py-4 px-2">
          <div className="flex flex-col space-y-1">
            ...
            <a href="/Yuri_Mauricio_Resume.pdf" download className="mt-2 mx-2 px-4 py-3 bg-[#facc15] text-[#0A192F] font-medium rounded-xl flex items-center justify-center gap-2">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>
              Resume
            </a>
          </div>
