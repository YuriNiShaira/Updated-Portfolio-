    ...
    <nav className={`fixed w-full z-50 transition-all duration-500 py-4 px-6 lg:px-8 ${scrolled ? 'bg-[#0A192F]/90 backdrop-blur-md shadow-lg' : 'bg-transparent'}`}>
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center space-x-1">
          ...
          <a href="/Yuri_Mauricio_Resume.pdf" download className="ml-2 px-5 py-2.5 bg-[#facc15] text-[#0A192F] text-sm font-medium rounded-xl hover:shadow-[0_0_20px_rgba(250,204,21,0.5)] transition-all duration-300 flex items-center gap-2">
